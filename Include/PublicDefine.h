...
enum eDeviceType
{
	...
	DeviceModel_HDEncoder = 0x01,
	DeviceModel_Decoder = 0x02,
	DeviceModel_Dec_Enc = 0x03,
};
...
#define MAXDECCHANN 16
#define MAXDISPLAYNUM 3
#define MAXENCCHAN 16
...
inline void TruncateLogFile()
{
    ...
    long MAX_LOG_SIZE = 8*1024*1024;//允许log最大长度
    long CLR_LOG_SIZE = 4*1024*1024;//裁剪长度
